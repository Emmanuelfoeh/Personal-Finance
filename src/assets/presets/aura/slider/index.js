export default {
  root: ({ props }) => ({
    class: [
      ...
      // Size
      {
        "h-1": props.orientation == "horizontal",
      ...
      // Colors
      "bg-surface-200 dark:bg-surface-700/50",
  ...
  handle: ({ props }) => ({
    class: [
      ...
      "before:block before:w-[16px] before:h-[16px] before:rounded-full before:bg-primary dark:before:bg-primary before:shadow-md",
